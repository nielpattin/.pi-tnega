...
import type { KeybindingsManager } from "@earendil-works/pi-coding-agent/dist/core/keybindings";
   ...
   private scheduleGhostUpdate(): void {
      ...
      this.optionsRef
         ...
         .catch((error) => {
            ...
            console.debug("[pi-footer] Failed to resolve bash ghost suggestion:", error);
         });
   }
}
