...
export default function (pi: ExtensionAPI) {
  pi.registerTool({
    ...
    promptGuidelines: [
      "Use web_reader when the user wants the contents of a public web page.",
    ],
    parameters: Type.Object({
      ...
      withImagesSummary: Type.Optional(
        Type.String({ description: "X-With-Images-Summary header. Default: all" }),
      ),
    }),
    ...
    renderResult(result, { expanded, isPartial }, theme) {
      ...
      if (details) {
        lines.push(theme.fg("dim", `base=${details.base} tokenBudget=${details.tokenBudget} images=${details.withImagesSummary}`));
      }
