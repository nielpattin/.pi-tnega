...
Examples:
  checkout.sh nielpattin/pi-tnega
  checkout.sh github.com/nielpattin/pi-tnega
  checkout.sh https://github.com/nielpattin/pi-tnega
  checkout.sh git@github.com:nielpattin/pi-tnega.git
