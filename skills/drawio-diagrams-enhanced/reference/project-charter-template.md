...
1. **Be Specific**: Provide concrete details, not vague statements
2. **Use SMART Criteria**: Make objectives measurable
3. **Keep High-Level**: Charter is not a detailed plan
4. **Get Input**: Involve stakeholders in defining content
5. **Update as Needed**: Charter can be revised during project
6. **Formal Approval**: Always get sponsor sign-off
